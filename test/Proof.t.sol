...
contract EscrowMPTTest is Test {
    ...
    function testCollectNativeWithTransactionProof_EIP1559() public {
        ...
        // NOTE: This test needs updated proof data that includes receipt proof for status verification
        // The receipt proof is required to verify the transaction succeeded (status == 1)
        // TODO: Regenerate proof data with receipt proof using eth_getProof for both tx and receipt
        Escrow.NativeTransferProof memory proof = Escrow.NativeTransferProof({
            ...
            txProofNodes: hex"",
            // Receipt for a simple ETH transfer: status=1, cumulativeGasUsed, logsBloom (empty), logs (empty)
            // This is a type-2 (EIP-1559) receipt with status success
            receiptRlp: hex"",
            receiptProofNodes: hex"", // TODO: Add actual receipt proof nodes
            path: hex"3d"
        });
